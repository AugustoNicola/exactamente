    ...
    estados: [
		{
			...
			render: {
				nodos: {
					0: {id: "0", label: "Gus", estilo: "rojo", x: 60.0, y: 35.0},
					1: {id: "1", label: "Gon", estilo: "rojo", x: 30.0, y: 50.0},
					2: {id: "2", label: "Mati", estilo: "rojo", x: 70.0, y: 70.0},
					3: {id: "3", label: "Vicky", estilo: "rojo", x: 80.0, y: 20.0}
				},
				aristas: [
