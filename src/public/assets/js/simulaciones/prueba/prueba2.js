    ...
    estados: [
		{
			...
			render: {
				nodos: {
					0: {id: "0", label: "Gus", estilo: "celeste", x: 70.0, y: 35.0},
					1: {id: "1", label: "Gon", estilo: "celeste", x: 40.0, y: 50.0},
					2: {id: "2", label: "Mati", estilo: "celeste", x: 80.0, y: 70.0},
					3: {id: "3", label: "Vicky", estilo: "celeste", x: 90.0, y: 20.0}
				},
				aristas: [
