    ...
    estados: [
		{
			...
			render: {
				nodos: {
					0: {id: "0", label: "Gus", estilo: "verde", x: 50.0, y: 35.0},
					1: {id: "1", label: "Gon", estilo: "verde", x: 20.0, y: 50.0},
					2: {id: "2", label: "Mati", estilo: "verde", x: 60.0, y: 70.0},
					3: {id: "3", label: "Vicky", estilo: "verde", x: 70.0, y: 20.0}
				},
				aristas: [
